...
<?php ob_start();?>
<h1 class="text-center text-4xl pt-20 mb-2">Modification du billet</h1>
...
<form action="index.php?action=update-post&amp;id=<?=$_GET['id']?>" method="POST" class="flex flex-col items-center justify-between w-full">
    ...
    <input type="submit" name="update" value="Modifier le billet" class="font-medium border border-solid border-blue-300 rounded-3xl py-2 px-3 bg-blue-300 my-2 cursor-pointer hover:bg-blue-400 text-sm md:text-base" />
</form>
</div>
<?php 
